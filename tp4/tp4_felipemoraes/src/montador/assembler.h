...
void Segundo_Passo(char* filename, char* output, TipoLista *symbol_table, TipoLista *opcode_table, TipoLista *size_table, TipoLista *reference_table);

int Decode(char *line, TipoLista symbol_table, TipoLista opcode_table, TipoLista *unknown_table, int *PC, int *memory);
#endif
